...
exports.INDENT = exports.INDENT_SIZE = exports.NULL_ADDRESS = exports.StorageSlot = exports.VerificationStatus = exports.RequestStatus = exports.EXPLORER_URLS = exports.API_URLS = exports.SOURCIFY_API_URL = exports.SUPPORTED_VERIFIERS = exports.VERSION = void 0;
exports.VERSION = '0.6.5';
exports.SUPPORTED_VERIFIERS = ['etherscan', 'sourcify'];
exports.SOURCIFY_API_URL = 'https://sourcify.dev/server/';
exports.API_URLS = {
...
(function (VerificationStatus) {
    VerificationStatus["FAILED"] = "Fail - Unable to verify";
    VerificationStatus["SUCCESS"] = "Pass - Verified";
    VerificationStatus["PARTIAL"] = "Pass - Partially Verified (with a metadata mismatch)";
    VerificationStatus["PENDING"] = "Pending in queue";
    VerificationStatus["ALREADY_VERIFIED"] = "Contract source code already verified";
    VerificationStatus["AUTOMATICALLY_VERIFIED"] = "Already Verified";
...
exports.INDENT = ' '.repeat(exports.INDENT_SIZE);
