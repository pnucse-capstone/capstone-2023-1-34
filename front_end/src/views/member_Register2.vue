<template>
  <div class="login">
    ...
    <form class="Regform">
      ...
      <p class="buttons">
        <button @click.prevent="doRegister" class="button blue" id="registerBtn" disabled>회원가입</button>
...
export default {
  ...
  methods : {
    ...
    getPositionValue (val) {
      ...
      var lon = val.coords.longitude;
      if((lat > 34.8799083 && lat < 35.3959361) && (lon >128.7384361 && lon <129.3728194 ))
        {document.getElementById("locate").innerHTML = "부산 지역 내에 위치하고 있습니다.";
        document.getElementById("registerBtn").disabled = false;
    }else{
        document.getElementById("locate").innerHTML = "부산 지역 내에 위치하고 있지 않습니다. 가입이 불가능합니다.";
      }
